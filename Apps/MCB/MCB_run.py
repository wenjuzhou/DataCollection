...
def run(params_dic,csv_path):
	...
	nx = random.randint(params_dic["min_nx"],params["max_nx"])
	ny = random.randint(params_dic["min_ny"],params["max_ny"])
	xmax = random.uniform(params_dic["min_xmax"],params["max_xmax"])
	ymax = random.uniform(params_dic["min_ymax"],params["max_ymax"])
...
def main():
    ...
    csv_path = "/home/cs/ustczwj/workspace/Data/AppsData/MCB/MCB-{}_{}_{}-{}_{}.csv".format(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5])
    run(params_dict,csv_path)
